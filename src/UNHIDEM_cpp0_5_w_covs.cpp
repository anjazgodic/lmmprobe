...
List UNHIDEM_cpp0_5_w_covs(const arma::vec y, const arma::mat Z,
  ...
  for (int col = 0; col < d; ++col) {
    ...
    // arma::colvec t_Wt2 = W_var -
    // curr_Z2*curr_delta(0)*(beta_var.row(col)+arma::square(beta_vec.row(col))*(1-curr_delta(0)));
    ...
    arma::mat Dt_t_Dt_1 =
        arma::join_rows(t_Dt1_t_Dt1, t_Dt1_t_Dt2, t_Dt1_t_Dt3);
    arma::mat Dt_t_Dt_2 =
        arma::join_rows(t_Dt2_t_Dt1, t_Dt2_t_Dt2, t_Dt2_t_Dt3);
    arma::mat Dt_t_Dt_3 =
        arma::join_rows(t_Dt3_t_Dt1, t_Dt3_t_Dt2, t_Dt3_t_Dt3);
    ...
    if (bXXt2.is_sympd()) {
      ...
      arma::mat Vbt =
          sigma2_lmm * arma::diagvec(arma::trans(XXt_inv) * (bXXt2)*XXt_inv);
